...
public class ViewVegetablesActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ViewVegetablesActivity.ViewPagerAdapter adapter = new ViewVegetablesActivity.ViewPagerAdapter(getSupportFragmentManager());
